...
Sekvenssi voidaan tallentaa joko .seqjson muotoisena json-tiedostona, johon on tallennettu kaikki sekvenssin asetukset tai yksikanavaisena .wav tiedostona. "Save sequence" napilla aukeaa tiedostohallintaikkuna johon syötetään tallennettavan .seqjson tiedoston nimi. Oletuskansio tallennetuille sekvensseille on ohjelman juurihakemistossa kansio ```/projects/```. "Load sequence" napilla aukeaa tiedostohallintaikkuna jolla avataan haluttu .seqjson tiedosto. Tässäkin oletushakemistona on ```/projects/```.
